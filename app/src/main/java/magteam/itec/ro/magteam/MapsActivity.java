...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCityBtn = findViewById(R.id.cityBtn);
        ...
        mCityBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MapsActivity.this, CityActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(bucharest).title("Bucharest Center"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(bucharest, 10F));
